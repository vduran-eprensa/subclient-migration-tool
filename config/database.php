    ...
    */
    ...
    'connections' => [
        ...
        'pgtarget' => [
            ...
            'port' => env('TARGET_DB_PORT', '5432'),
            'database' => env('TARGET_DB_DATABASE', 'laravel'),
            'username' => env('TARGET_DB_USERNAME', 'root'),
            'password' => env('TARGET_DB_PASSWORD', ''),
            'charset' => env('TARGET_DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
            'sslmode' => 'prefer',
        ...
        'queuedb' => [
            ...
            'port' => env('QUEUE_DB_PORT', '5432'),
            'database' => env('QUEUE_DB_DATABASE', 'laravel'),
            'username' => env('QUEUE_DB_USERNAME', 'root'),
            'password' => env('QUEUE_DB_PASSWORD', ''),
            'charset' => env('QUEUE_DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
            'sslmode' => 'prefer',
